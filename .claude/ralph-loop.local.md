...
active: true
iteration: 1
session_id: a5b484ce-ec0f-4c72-8882-f22182f81774
max_iterations: 20
completion_promise: "CAVEKIT COMPLETE"
started_at: "2026-04-18T21:14:09Z"
---
...
- `context/kits/cavekit-bench-research-distro.md`
- `context/kits/cavekit-brand-cleanup.md`
- `context/kits/cavekit-cost-trace.md`
- `context/kits/cavekit-documentation.md`
- `context/kits/cavekit-edit-tools.md`
- `context/kits/cavekit-extension-workflow.md`
- `context/kits/cavekit-fullscreen-viewport.md`
- `context/kits/cavekit-input-compression.md`
- `context/kits/cavekit-localizer-verifier.md`
- `context/kits/cavekit-model-routing.md`
- `context/kits/cavekit-overview.md`
- `context/kits/cavekit-prompt-cache.md`
- `context/kits/cavekit-repomap.md`
- `context/kits/cavekit-rtk-integration.md`
- `context/kits/cavekit-sandbox-mcp.md`
- `context/kits/cavekit-session-checkpoints.md`
- `context/kits/cavekit-startup-experience.md`
- `context/kits/cavekit-terminal-blend.md`
- `context/kits/cavekit-tool-result-cache.md`
- `context/kits/cavekit-visual-theme.md`
- `context/kits/kit-brand-expression.md`
- `context/kits/kit-config.md`
- `context/kits/kit-feature-intake.md`
- `context/kits/kit-interaction-model.md`
- `context/kits/kit-layout-navigation.md`
- `context/kits/kit-readme-information-architecture.md`
- `context/kits/kit-readme-onboarding.md`
- `context/kits/kit-readme-positioning.md`
- `context/kits/kit-readme-trust-signals.md`
- `context/kits/kit-visual-language.md`
false_SECTION
## Each Iteration
